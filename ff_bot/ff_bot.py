...
if __name__ == '__main__':
    ...
    sched.add_job(bot_main, 'cron', ['get_matchups'], id='matchups', day_of_week='thu', minute='0-59', start_date=ff_start_date, end_date=ff_end_date, timezone=myTimezone, replace_existing=True)
